    ...
    hamburger.addEventListener("click", function(){
        ...
        if (open) {
            console.log("it is open and it is going to close");
            document.getElementById("navigation__list").style.display = "none";
            ...
            console.log("it is close and is going to open");
            document.getElementById("navigation__list").style.display = "flex";
